        ...
        <el-row :gutter="20">
            <el-col :span="20" :offset="2">
                <div class="order-header flexbox">
                      ...
                      <span style="float: right;"><el-button size="small" type="primary" @click="submit" :loading="SubmitLoading">Submit</el-button></span>
                  </div>
                                ...
                                <ul class="customer-info mt10">
                                    ...
                                    <li>
                                        <el-form-item label="After Sales Products:" prop="product_json">
                                            <el-select multiple v-model="formData.product_json" class="w-180 custSel">
