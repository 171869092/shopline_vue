    ...
    <main>
        ...
        <div class="About-banner">
          <div class="container">
            <div style="padding-top: 100px;">
              ...
              <h2 class="title-p">
                At FbAli, we believe everyone deserves a fast and efficient
                ordering method. Efficiency and Innovation are our main goal and
                we strive in removing any technical barriers or difficulties that
                can prevent dropshippers from selling goods and closing orders.
      ...
      <section class="wap wap-top">
        <div class="container">
          ...
          <div class="block">
            <p class="block-title">
              FbAli provides lightweight ERP including product management,
              orders management and shipping management, and auto-processing for
              orders to merchants who use Shopify to power their stores. This
              Privacy Policy describes how personal information is collected,
              used, and shared when you install or use the App in connection
      ...
      <section class="wap wap-top">
        <div class="container">
          <h3 class="title">Personal Information the App Collects</h3>
          <div class="block">
            <p class="block-title">
              When you install the App, we are automatically able to access
              certain types of information from your Shopify account: products,
              orders, shipping and fulfillments and setting information.
            </p>
            <p class="block-title">
              ...
              the App: Information about you and others who may access the App
              on behalf of your store, such as your name, address, email
              address, phone number, and billing information; Information about
              individuals who visit your store, such as their IP address, web
              browser details, time zone, and information about the cookies
              installed on the particular device.
            </p>
            <p class="block-title">
      ...
      <section class="wap wap-top">
        <div class="container">
          <h3 class="title">How Do We Use Your Personal Information?</h3>
          <div class="block">
            <p class="block-title">
              ...
              Additionally, we use this personal information to: Communicate
              with you; Optimize or improve the App; and Provide you with
              information or advertising relating to our products or services.
              Also we will pass orders information to your selected sourcing
              agent.
            </p>
          </div>
        </div>
      ...
      <section class="wap wap-top">
        <div class="container">
          <h3 class="title">Sharing Your Personal Information</h3>
          <div class="block">
            <p class="block-title">
        ...
        <div class="container">
          ...
          <div class="block">
            <p class="block-title">
              ...
              please contact us by e-mail at fulfilbyali@gmail.com or by mail
...
<style scoped>
.About-banner {
  background: url("../../assets/home/banner-about.jpg") no-repeat;
  height: 490px;
  /* margin-top: -80px; */
  width: 100%;
